  ...
  <div class="client-dashboard">
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card">
        ...
        <div class="stat-info">
          <h3>Total Spent</h3>
          <p class="stat-value">${{ formatPrice(stats.totalSpent) }}</p>
        </div>
      </div>
    ...
    <div class="quick-actions">
      ...
      <div class="actions-grid">
        <div class="action-card" @click="navigateTo('/client/orders/new')">
...
onMounted(async () => {
  try {
    ...
    if (profileResponse.success) {
      clientName.value = profileResponse.client.company_name
    }
